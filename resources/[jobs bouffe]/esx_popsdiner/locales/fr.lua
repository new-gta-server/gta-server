Locales['fr'] = {
    ...
    ['popsdiner_fridge_stock']     = 'Frigo du popsdiner',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du popsdiner',
    ...
    ['popsdiner_stock']            = 'Stock du popsdiner',
    ...
    -- Ingredientg Menu  
    ['open_entrecote']          = 'Appuyez sur ~INPUT_CONTEXT~ pour cuire un entrecote',
    ['ingredient']                 = 'Préparation',
    ['cuttomate']                  = 'Couper des tomates',
    ['lavesalade']                   = 'Laver la salade',
    ['cuireentrecote']                 = 'Cuire le entrecote',
    ['friteuse']                 = 'Mettre dans la friteuse',
    ['fromage']                = 'Fromage',
    ['salads']                 = 'Salade sale',
    ['tomater']                = 'Tomate',
    ['entrecotec']                = 'entrecote Crue',
    ['patate']                = 'Patate',
    ...
    -- Phone  
    ['popsdiner_phone']            = 'popsdiner',
    ['popsdiner_customer']         = 'Citoyen',

    -- Items utilisable
    ['used_grillade']            = 'Vous mangez une Grillade',
    ...
    -- Run
  ['popsdiner_client'] = 'client popsdiner',
