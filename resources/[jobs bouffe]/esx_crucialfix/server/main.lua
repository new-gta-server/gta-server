...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'crucialfix', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'crucialfix', _U('crucialfix_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'crucialfix', 'crucialfix', 'society_crucialfix', 'society_crucialfix', 'society_crucialfix', {type = 'private'})

RegisterServerEvent('esx_crucialfix:annonce')
AddEventHandler('esx_crucialfix:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_crucialfix:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_crucialfix:annoncestop', xPlayers[i])
  end

end)


RegisterServerEvent('esx_crucialfix:getStockItem')
AddEventHandler('esx_crucialfix:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_crucialfix', function(inventory)
...
ESX.RegisterServerCallback('esx_crucialfix:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_crucialfix:putStockItems')
AddEventHandler('esx_crucialfix:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_crucialfix:getFridgeStockItem')
AddEventHandler('esx_crucialfix:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_crucialfix_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_crucialfix:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_crucialfix:putFridgeStockItems')
AddEventHandler('esx_crucialfix:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_crucialfix:buyItem')
AddEventHandler('esx_crucialfix:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_crucialfix', function(account)
...
RegisterServerEvent('esx_crucialfix:ingredientgBurger')
AddEventHandler('esx_crucialfix:ingredientgBurger', function(itemValue)
 ...
 if _itemValue == 'cuttomate' then
     ...
     if _itemValue == 'lavesalade' then
        SetTimeout(10000, function()        
         ...
         if _itemValue == 'cuirejambon' then
        SetTimeout(10000, function()        

            local xPlayer           = ESX.GetPlayerFromId(_source)

            local alephQuantity     = xPlayer.getInventoryItem('jambonc').count

            if alephQuantity < 1 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('jambonc') .. '~w~')
            else
                local chanceToMiss = math.random(100)
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('term_miss'))
                    xPlayer.removeInventoryItem('jambonc', 1)
                else
                    TriggerClientEvent('esx:showNotification', _source, _U('jamboncui') .. _U(' term') .. ' ~w~!')
                    xPlayer.removeInventoryItem('jambonc', 1)
                    xPlayer.addInventoryItem('jamboncui', 1)
                end
            end
...
RegisterServerEvent('esx_crucialfix:craftingBurger')
AddEventHandler('esx_crucialfix:craftingBurger', function(itemValue)
 ...
 if _itemValue == 'sandwich' then
        SetTimeout(10000, function()        
            ...
            local gameQuantity     = xPlayer.getInventoryItem('jamboncui').count 
            ...
            elseif gameQuantity < 1 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('jamboncui') .. '~w~')
            else
                local chanceToMiss = math.random(100)
                if chanceToMiss <= Config.MissCraft then
                    ...
                    xPlayer.removeInventoryItem('jamboncui', 1)
                else
                    TriggerClientEvent('esx:showNotification', _source, _U('sandwich') .. _U(' craft') .. ' ~w~!')
                    xPlayer.removeInventoryItem('bread', 2)
                    xPlayer.removeInventoryItem('fromage', 2)
                    xPlayer.removeInventoryItem('tomatec', 2)
                    xPlayer.removeInventoryItem('saladp', 2)
...
ESX.RegisterServerCallback('esx_crucialfix:getPlayerInventory', function(source, cb)
