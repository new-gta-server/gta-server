Locales['fr'] = {
    ...
    ['cluckinbell_fridge_stock']     = 'Frigo du cluckinbell',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du cluckinbell',
    ...
    ['cluckinbell_stock']            = 'Stock du cluckinbell',
    ...
    -- Ingredientg Menu  
    ['open_poulet']          = 'Appuyez sur ~INPUT_CONTEXT~ pour cuire un poulet',
    ['ingredient']                 = 'Préparation',
    ['cuttomate']                  = 'Couper des tomates',
    ['lavesalade']                   = 'Laver la salade',
    ['cuirepoulet']                 = 'Cuire le poulet',
    ...
    -- Misc  
    ['map_blip']                 = 'Cluckinbell',
    ['cluckinbell']                  = 'Cluckinbell',

    -- Phone  
    ['cluckinbell_phone']            = 'Cluckinbell',
    ['cluckinbell_customer']         = 'Citoyen',

    -- Items utilisable
    ['used_tender']            = 'Vous mangez un Tender',
    ...
    -- Run
  ['cluckinbell_client'] = 'client cluckinbell',
