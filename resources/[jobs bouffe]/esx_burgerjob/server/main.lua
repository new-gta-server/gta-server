...
RegisterServerEvent('esx_burgerjob:annonce')
AddEventHandler('esx_burgerjob:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_burgerjob:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_burgerjob:annoncestop', xPlayers[i])
  end
