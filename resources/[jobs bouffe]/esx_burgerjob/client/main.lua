    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_burgerjob:annonce',result)
...
Citizen.CreateThread(function()
        while true do
            Citizen.Wait(1)    
                ...
                DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~y~ BURGERSHOT ~d~", 255, 255, 255, 255, 1, 0)
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('burgershot_outfit'),    value = 'burgershot_outfit'},
  }
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_burgershot', _U('billing'), amount)
        end
...
RegisterNetEvent('esx_burgerjob:annonce')
AddEventHandler('esx_burgerjob:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_burgerjob:annoncestop')
AddEventHandler('esx_burgerjob:annoncestop', function()
    affichenews = false
