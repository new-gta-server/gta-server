Locales['fr'] = {
    ...
    ['pearls_fridge_stock']     = 'Frigo du pearls',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du pearls',
    ...
    -- Ingredientg Menu  
    ['open_poisson']          = 'Appuyez sur ~INPUT_CONTEXT~ pour cuire un poisson',
    ['ingredient']                 = 'Préparation',
    ['cuttomate']                  = 'Couper des tomates',
    ['lavesalade']                   = 'Laver la salade',
    ['cuirepoisson']                 = 'Cuire le poisson',
    ['friteuse']                 = 'Mettre dans la friteuse',
    ['fromage']                = 'Fromage',
    ['salads']                 = 'Salade sale',
    ['tomater']                = 'Tomate',
    ['poissonc']                = 'poisson Cru',
    ['patate']                = 'Patate',
    ...
    -- Phone  
    ['pearls_phone']            = 'pearls',
    ['pearls_customer']         = 'Citoyen',

    -- Items utilisable
    ['used_sushi']            = 'Vous mangez un sushi',
