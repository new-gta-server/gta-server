...
--[[local blips = {
  ...
  {title="~p~bloods", colour=83, id=84, x = 70.59, y = -1911.92, z = 20.8}
  }
  Citizen.CreateThread(function()
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('bloods_wear'), value = 'bloods_wear'}
  }
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_bloodsjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_bloodsjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_bloodsjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_bloodsjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_bloodsjob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_bloodsjob:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_bloodsjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_bloodsjob:buy', function(hasEnoughMoney)
...
AddEventHandler('esx_bloodsjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_bloodsjob:drag', function(cop)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' and PlayerData.job2.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') and (GetGameTimer() - GUI.Time) > 150 then
