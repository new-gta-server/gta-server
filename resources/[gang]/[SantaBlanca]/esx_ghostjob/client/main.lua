...
--[[local blips = {
  ...
  {title="~p~ghost", colour=83, id=84, x = 70.59, y = -1911.92, z = 20.8}
  }
  Citizen.CreateThread(function()
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('ghost_wear'), value = 'ghost_wear'}
  }
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'ghost_wear' then
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_ghostjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, vehicles[partNum].SpawnPoint, 94.5, function(vehicle)
            ESX.Game.SetVehicleProperties(vehicle, vehicleProps)
            local playerPed = GetPlayerPed(-1)
            TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
          end)

          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'ghost', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_ghostjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_ghostjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_ghostjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_ghostjob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_ghostjob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_ghostjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_ghostjob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_ghostjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_ghostjob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_ghostjob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_ghostjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_ghostjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ghostjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ghostjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ghostjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ghostjob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_ghostjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_ghostjob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_ghostjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'ghost' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_ghostjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_ghostjob:handcuff')
AddEventHandler('esx_ghostjob:handcuff', function()
...
RegisterNetEvent('esx_ghostjob:drag')
AddEventHandler('esx_ghostjob:drag', function(cop)
...
RegisterNetEvent('esx_ghostjob:putInVehicle')
AddEventHandler('esx_ghostjob:putInVehicle', function()
...
RegisterNetEvent('esx_ghostjob:OutVehicle')
AddEventHandler('esx_ghostjob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'ghost' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ghost' and PlayerData.job2.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'ghost' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_ghostjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_ghostjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
...
RegisterNetEvent('NB:openMenughost')
AddEventHandler('NB:openMenughost', function()
	OpenghostActionsMenu()
end)
