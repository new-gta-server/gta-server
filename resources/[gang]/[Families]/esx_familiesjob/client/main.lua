...
--[[local blips = {
  ...
  {title="~p~families", colour=83, id=84, x = 70.59, y = -1911.92, z = 20.8}
  }
  Citizen.CreateThread(function()
...
AddEventHandler('esx_familiesjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'families' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'families' then
