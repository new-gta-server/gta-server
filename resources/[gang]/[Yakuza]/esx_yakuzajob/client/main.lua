...
--[[local blips = {
  ...
  {title="~p~yakuza", colour=83, id=84, x = 70.59, y = -1911.92, z = 20.8}
  }
  Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, vehicles[partNum].SpawnPoint, 265.0, function(vehicle)
...
AddEventHandler('esx_yakuzajob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'yakuza' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'yakuza' then
