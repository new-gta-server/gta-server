...
Config.Zones = {
	...
	Garages = {
		...
		{  -- Cayo Perico
		    GaragePos  = vector3(4763.38, -4780.94, 3.0),
		    SpawnPoint = vector4(4758.03, -4789.30, 1.21, 148.45),
		    StorePos   = vector3(4755.36, -4793.65, 0.5),
		    StoreTP    = vector4(4763.38, -4780.94, 2.5, 148.45)
	    },
...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 70000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 70000},
	{model = 'suntrap', label = 'Suntrap', price = 110000},
	{model = 'jetmax', label = 'Jetmax', price = 215000},
	{model = 'tropic2', label = 'Tropic', price = 300000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 175000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 250000},
	{model = 'speeder', label = 'Speeder', price = 350000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 150000},
	{model = 'toro', label = 'Toro', price = 500000},
	--{model = 'predator', label = 'Predator', price = 1},
	{model = 'submersible', label = 'Submersible', price = 1500000}
}