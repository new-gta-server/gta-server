...
AddEventHandler('esx_vangelico_robbery:gioielli1', function()
	...
	xPlayer.addInventoryItem('jewels', 2)
end)
...
local function Craft(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true and CopsConnected >= Config.RequiredCopsSell then
			...
			local xPlayer  = ESX.GetPlayerFromId(source)
			local Dia_boxQuantity = xPlayer.getInventoryItem('dia_box').count

			if Dia_boxQuantity < 1 then 
				TriggerClientEvent('esx_vangelico_robbery:VenteDiamantRefuser', source)
			else   
				TriggerClientEvent('esx_vangelico_robbery:VenteDiamant', source)
...
AddEventHandler('lester:vendita', function()
	local _source = source
	PlayersCrafting[_source] = true
	TriggerClientEvent('esx:showNotification', _source, 'Tu donne t\'es diamant au revendeur ...')
	Craft(_source)
end)
...
local function Craft(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true and CopsConnected >= Config.RequiredCopsSell then
			...
			local xPlayer  = ESX.GetPlayerFromId(source)
			local Gold_barQuantity = xPlayer.getInventoryItem('gold_bar').count

			if Gold_barQuantity < 1 then 
				TriggerClientEvent('esx_vangelico_robbery:VenteGoldRefuser', source)
			else   
				TriggerClientEvent('esx_vangelico_robbery:VenteGold', source)
...
AddEventHandler('lester:vendita', function()
	local _source = source
	PlayersCrafting[_source] = true
	TriggerClientEvent('esx:showNotification', _source, 'Tu donne t\'es gold_bar au revendeur ...')
	Craft(_source)
end)
...
AddEventHandler('lester:vendita', function()
	local _source = source
	PlayersCrafting[_source] = true
	TriggerClientEvent('esx:showNotification', _source, 'Tu donne t\'es gold au revendeur ...')
	Craft(_source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true and CopsConnected >= Config.RequiredCopsSell then
			...
			if RolexQuantity < 1 then 
				TriggerClientEvent('esx_vangelico_robbery:VenteRolexRefuser', source)
			else   
				TriggerClientEvent('esx_vangelico_robbery:VenteRolex', source)
...
AddEventHandler('lester:vendita', function()
	local _source = source
	PlayersCrafting[_source] = true
	TriggerClientEvent('esx:showNotification', _source, 'Tu donne t\'es rolex au revendeur ...')
	Craft(_source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true and CopsConnected >= Config.RequiredCopsSell then
			...
			if DiamondQuantity < 1 then 
				TriggerClientEvent('esx_vangelico_robbery:VenteDiamondRefuser', source)
			else   
				TriggerClientEvent('esx_vangelico_robbery:VenteDiamond', source)
...
AddEventHandler('lester:vendita', function()
	local _source = source
	PlayersCrafting[_source] = true
	TriggerClientEvent('esx:showNotification', _source, 'Tu donne t\'es diamond au revendeur ...')
	Craft(_source)
end)
