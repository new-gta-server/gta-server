...
--[[ Main Event Handlers ]]--
    ...
    AddEventHandler("K9:SearchVehicle", function(items, openDoors)
        ...
        if vehicle ~= 0 and not searching then
            ...
            Notification(tostring(k9_name .. " commence à fouiller..."))
            ...
            Notification(tostring(k9_name .. " a trouvé [ " .. tostring(table.concat(stringified_table, ", ")) .. " ]."))
            searching = false
        end
    end)
...
--[[ Threads ]]
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            -- Trigger Opens Menu
            if IsControlPressed(1, 19) and IsControlJustPressed(1, 101) then
