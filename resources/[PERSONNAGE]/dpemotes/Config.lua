...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 289, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animations',
        ['danceemotes'] = "🕺 Liste des Dances",
        ['propemotes'] = "📦 Animations Objets",
        ['favoriteemotes'] = "🌟 Vos Favoris",
        ...
        ['walkingstyles'] = "Liste des Démarches",
  ...
  ['fr'] = {
        ['emotes'] = 'Liste des Animations',
        ['danceemotes'] = "🕺 Liste des danses",
        ['propemotes'] = "📦 Animations avec Objets",
        ['favoriteemotes'] = "🌟 vos Favoris",
