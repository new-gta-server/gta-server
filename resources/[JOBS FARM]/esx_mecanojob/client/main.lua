...
Citizen.CreateThread(function()
        while true do
            Citizen.Wait(1)    
                ...
                DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~w~ BENNYS ~d~", 255, 255, 255, 255, 1, 0)
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
					...
					ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
						...
						ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 356.46, function(vehicle)
				...
				local elements = {
					...
					{label = _U('slamtruck'), value = 'slamtruck'}
				}
...
function OpenMobileMecanoActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_mecano_actions', {
		...
		elements = {
			...
			{label = _U('Passer une annonce'), value = 'announce'}
		}
	}, function(data, menu)
