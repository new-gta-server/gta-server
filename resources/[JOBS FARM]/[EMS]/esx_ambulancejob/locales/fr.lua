Locales['fr'] = {
  ...
  ['Passer une annonce']        = 'Annonce EMS',
  -- Vehicles
  ['veh_menu'] = 'véhicule',
  ...
  ['yes'] = 'Oui',
  ['no'] = 'Non',
  ['please_wait'] = 'Vous serez automatiquement transporté à l\'hôpital dans ~r~%s minutes %s secondes~s~',
  ['press_respawn'] = 'appuyez sur [~b~E~w~] pour réapparaître.',
  ['respawn_fine'] = 'vous avez payer ~r~$%s~s~ pour réapparaître.',
  ['distress_send'] = '[~o~G~s~] pour envoyé un signal de detresse.~n~Rappel Téléphone si pas de réponse\n',
  ...
  -- Pnj
  ['must_in_ambulance'] = 'vous devez être dans une ambulance pour commencer la mission',
  ...
  ['close_to_client'] = 'vous êtes à proximité du malade, arretez vous.',
