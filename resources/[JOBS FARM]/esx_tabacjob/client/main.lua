    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
                  ...
                  ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 66.34, function(vehicle)
            ...
            local elements = {
              {label = 'Livraison', value = 'burrito8'},
            ...
            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              ...
              table.insert(elements, {label = 'Véhicule Patron', value = 'tailgater'})
            end
              ...
              function(data, menu)
                for i=1, #elements, 1 do
                  if Config.MaxInService == -1 then
                    ESX.Game.SpawnVehicle(data.current.value, Config.Zones.VehicleSpawnPoint.Pos, 66.34, function(vehicle)
                      local playerPed = GetPlayerPed(-1)
                      local platenum = math.random(100, 900)
                      SetVehicleNumberPlateText(vehicle, "TBC" .. platenum)
                      TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
