Locales['fr'] = {
  ['repair']                    = 'Réparer',
  ['mechanic']                  = 'Dreams Records',
  ['drive_to_indicated']        = '~y~Conduisez~s~ jusqu\'à l\'endroit indiqué',
  ['mission_canceled']          = 'Mission ~r~annulée~s~',
  ['vehicle_list']              = 'Sortir un véhicule',
  ['work_wear']                 = 'tenue de travail',
  ['civ_wear']                  = 'Tenue civile',
  ['deposit_stock']             = 'Déposer un objet dans le stock',
  ['withdraw_stock']            = 'Prendre un objet dans le Stock',
  ['boss_actions']              = 'Action du patron',
