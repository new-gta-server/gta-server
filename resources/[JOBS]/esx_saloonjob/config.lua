...
Config.AuthorizedVehicles = {
    { name = 'burrito11',  label = 'Vanilla Saloon Burrito' },
    { name = 'oracle2',  label = 'Vanilla Saloon Oracle' },
}

Config.Blips = {
    
    Blip = {
      Pos     = { x = -300.11, y = 6255.76, z = 31.52 },
      Sprite  = 103,
      Display = 4,
      Scale   = 0.5,
      Colour  = 27,
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x = 108.64, y = -1306.01, z = -10000000000000000000000000000.26 },
    ...
    Fridge = {
        Pos   = { x = -312.18, y = 6267.18, z = 30.53 },
    ...
    Vehicles = {
        Pos          = { x = -302.42, y = 6286.19, z = 30.19 },
        SpawnPoint   = { x = -306.03, y = 6282.68, z = 31.49 },
    ...
    VehicleDeleters = {
        Pos   = { x = -309.82, y = 6279.64, z = 30.53 },
...
--[[
    ...
    BossActions = {
        Pos   = { x = -294.28, y = 6265.86, z = 30.64 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 1,
    },
...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = -302.23, y = 6271.87, z = 30.53 },
        ...
        Items = {
            ...
            { name = 'whisky',     label = _U('whisky'),  price = 25 },
            { name = 'tequila',    label = _U('tequila'), price = 10 },
            { name = 'martini',    label = _U('martini'), price = 15 }
        },
    },

    NoAlcool = {
        Pos   = { x = -303.86, y = 6270.57, z = 30.53 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 238, g = 110, b = 0 },
        Type  = 27,
        Items = {
            { name = 'soda',        label = _U('soda'),     price = 12 },
            { name = 'jusfruit',    label = _U('jusfruit'), price = 8 },
            { name = 'icetea',      label = _U('icetea'),   price = 9 },
            { name = 'energy',      label = _U('energy'),   price = 20 },
            { name = 'drpepper',    label = _U('drpepper'), price = 10 },
            { name = 'limonade',    label = _U('limonade'), price = 8 }
        },
    },

    Apero = {
        Pos   = { x = -305.45, y = 6268.96, z = 30.53 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        ...
        Items = {
            ...
            { name = 'bolchips',        label = _U('bolchips'),         price = 25 },
            { name = 'saucisson',       label = _U('saucisson'),        price = 10 },
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 15 }
        },
    },

    Ice = {
        Pos   = { x = -306.91, y = 6267.43, z = 30.53 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
...
--[[Config.TeleportZones = {
  EnterBuilding = {
    Pos       = { x = 888888.608, y = -1293.978, z = 444444.269 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_enter_1'),
    Teleport  = { x = 888888.742, y = -1278.386, z = 55555.569 }
  },

  ExitBuilding = {
    Pos       = { x = 1888882.517, y = -1290.901, z = 4444444.269 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_exit_1'),
    Teleport  = { x = 188888881.175, y = -1295.598, z = 55555.569 },
  },
