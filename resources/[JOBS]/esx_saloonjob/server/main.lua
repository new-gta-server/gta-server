...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'saloon', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'saloon', _U('saloon_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'saloon', 'saloon', 'society_saloon', 'society_saloon', 'society_saloon', {type = 'private'})

RegisterServerEvent('esx_saloonjob:annonce')
AddEventHandler('esx_saloonjob:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_saloonjob:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_saloonjob:annoncestop', xPlayers[i])
  end

end)

RegisterServerEvent('esx_saloonjob:getStockItem')
AddEventHandler('esx_saloonjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_saloon', function(inventory)
...
ESX.RegisterServerCallback('esx_saloonjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_saloonjob:putStockItems')
AddEventHandler('esx_saloonjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_saloonjob:getFridgeStockItem')
AddEventHandler('esx_saloonjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_saloon_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_saloonjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_saloonjob:putFridgeStockItems')
AddEventHandler('esx_saloonjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_saloonjob:buyItem')
AddEventHandler('esx_saloonjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_saloon', function(account)
...
RegisterServerEvent('esx_saloonjob:craftingCoktails')
AddEventHandler('esx_saloonjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_saloonjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_saloon', function(store)
...
ESX.RegisterServerCallback('esx_saloonjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_saloonjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_saloonjob:getPlayerInventory', function(source, cb)
