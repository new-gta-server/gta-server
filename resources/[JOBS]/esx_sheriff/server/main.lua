...
RegisterServerEvent('esx_sheriffjob:annonce')
AddEventHandler('esx_sheriffjob:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_sheriffjob:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_sheriffjob:annoncestop', xPlayers[i])
  end
...
RegisterServerEvent('esx_sheriffjob:handcuff1')
AddEventHandler('esx_sheriffjob:handcuff1', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'sheriff' then
		TriggerClientEvent('esx_sheriffjob:handcuff1', target)
	else
...
RegisterServerEvent('esx_sheriffjob:getStockItem1')
AddEventHandler('esx_sheriffjob:getStockItem1', function(itemName, count)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
...
RegisterServerEvent('esx_sheriffjob:putStockItems1')
AddEventHandler('esx_sheriffjob:putStockItems1', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
...
ESX.RegisterServerCallback('esx_sheriffjob:getSaisiWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_sheriffjob:addSaisiWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_sheriffjob:removeSaisiWeapon', function(source, cb, weaponName)
