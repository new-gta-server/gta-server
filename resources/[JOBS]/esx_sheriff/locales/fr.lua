Locales['fr'] = {
  ...
  ['Passer une annonce']        = 'Annonce Sheriff',
  -- Armory
  ['remove_object'] = 'Prendre Objet',
  ['deposit_object'] = 'Déposer objet',
  ['remove_object1'] = 'Prendre une Saisi',
  ['deposit_object1'] = 'Déposer une Saisi',
  ['get_weapon'] = 'prendre Arme',
  ['put_weapon'] = 'déposer Arme',
  ['buy_weapons'] = 'acheter Armes',
  ['saisi'] = 'saisi',
  ['open_saisi'] = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au saisi',
  ['armory'] = 'armurerie',
